...
> Origem: `rafaelmeloreisnovo/Vectras-VM-Android`  
> Caminho: `docs/rafaelia_reference/sqrt3_2_kernel.md`  
> Commit observado: `6ab34fcfbbaa7fa3536507d9c42d066d2fe94365`  
> Classificação: `rafaelia_original` com `sole_author=null` até auditoria genealógica.  
> Esta formulação usa matemática padrão e **não implementa** a Regressão de Júlia.
