...
#if RAF_B7_HAVE_NEON
for(;i+16u<=w;i+=16u){uint32x4_t a=vld1q_u32((const uint32_t*)(const void*)(s+(i+0u)*4u)),b=vld1q_u32((const uint32_t*)(const void*)(s+(i+4u)*4u)),c=vld1q_u32((const uint32_t*)(const void*)(s+(i+8u)*4u)),e=vld1q_u32((const uint32_t*)(const void*)(s+(i+12u)*4u));a=vmulq_n_u32(veorq_u32(a,vld1q_u32(salt)),PHI32);b=vmulq_n_u32(veorq_u32(b,vld1q_u32(salt+4)),PHI32);c=vmulq_n_u32(veorq_u32(c,vld1q_u32(salt+8)),PHI32);e=vmulq_n_u32(veorq_u32(e,vld1q_u32(salt+12)),PHI32);a=veorq_u32(vorrq_u32(vshlq_n_u32(a,7),vshrq_n_u32(a,25)),vshrq_n_u32(vorrq_u32(vshlq_n_u32(a,7),vshrq_n_u32(a,25)),11));b=veorq_u32(vorrq_u32(vshlq_n_u32(b,7),vshrq_n_u32(b,25)),vshrq_n_u32(vorrq_u32(vshlq_n_u32(b,7),vshrq_n_u32(b,25)),11));c=veorq_u32(vorrq_u32(vshlq_n_u32(c,7),vshrq_n_u32(c,25)),vshrq_n_u32(vorrq_u32(vshlq_n_u32(c,7),vshrq_n_u32(c,25)),11));e=veorq_u32(vorrq_u32(vshlq_n_u32(e,7),vshrq_n_u32(e,25)),vshrq_n_u32(vorrq_u32(vshlq_n_u32(e,7),vshrq_n_u32(e,25)),11));vst1q_u32((uint32_t*)(void*)(d+(i+0u)*4u),a);vst1q_u32((uint32_t*)(void*)(d+(i+4u)*4u),b);vst1q_u32((uint32_t*)(void*)(d+(i+8u)*4u),c);vst1q_u32((uint32_t*)(void*)(d+(i+12u)*4u),e);}
#endif
