...
import com.rafgittools.ui.screens.rafgitfs.WorkspaceEditorScreen
                    ...
                    NavHost(
                        ...
                        composable(
                            ...
                            VirtualFileBrowserScreen(
                                ...
                                onOpenWorkspace = { profileId, repository, ref ->
                                    navController.navigate(
                                        RafGitFsRoute.Workspace.create(profileId, repository, ref)
                                    )
                                }
                            )
                        }
                        ...
                        composable(
                            route = RafGitFsRoute.Workspace.route,
                            arguments = listOf(
                                navArgument("profileId") { type = NavType.StringType },
                                navArgument("repositoryFullName") { type = NavType.StringType },
                                navArgument("refName") { type = NavType.StringType }
...
private sealed class RafGitFsRoute(val route: String) {
    ...
    object Workspace : RafGitFsRoute(
        "rafgitfs_workspace/{profileId}/{repositoryFullName}/{refName}"
    ) {
        fun create(profileId: String, repository: String, ref: String) =
            "rafgitfs_workspace/${encode(profileId)}/${encode(repository)}/${encode(ref)}"
    }
